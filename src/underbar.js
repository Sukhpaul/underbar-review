(function() {
   ...
   * ===========
   *
   * The .first function ileads implemented for you, to help guide you toward success
   * in your work on the following functions. Whenever you see a portion of the
   * assignment pre-completed, be sure to read and understand it fully before
   * you proceed. Skipping this step will  to considerably more difficulty
  ...
  _.map = function(collection, iterator) {
    ...
    //run each and push the resulting element after the iterator is used into output array
